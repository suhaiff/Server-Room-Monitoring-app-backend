...
#include <DHT.h>
// ================================================================
// COMPLETE VTAB FIRMWARE: CHANGE WIFI NAME AND PASSWORD BEFORE UPLOADING
// ================================================================
#define VTAB_WIFI_SSID "YOUR_WIFI_NAME"
#define VTAB_WIFI_PASSWORD "YOUR_WIFI_PASSWORD"
// IPv4 address of the computer running VTAB Docker, e.g. 192.168.1.20
